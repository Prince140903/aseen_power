...
export default function AboutView() {
  ...
  return (
    <div className="bg-[#fbf9f8] dark:bg-[#0f1115] min-h-screen py-16 sm:py-24" id="about-us-container">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-24" id="statistics-metric-row">
          {stats.map((stat, i) => (
            <div 
              key={i} 
              className="bg-white dark:bg-[#1a1c22] p-6 sm:p-8 rounded-lg border border-[#e9e8e7] dark:border-[#3a3d45] flex flex-col items-center text-center shadow-sm relative overflow-hidden group hover:border-[#785919] dark:hover:border-[#eac076] transition-all duration-300"
            >
              {/* Subtle visual touch to imply engineering blueprint */}
              <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-[#c4c7c7] dark:border-[#3a3d45] group-hover:border-[#785919] dark:group-hover:border-[#eac076]" />
              <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-[#c4c7c7] dark:border-[#3a3d45] group-hover:border-[#785919] dark:group-hover:border-[#eac076]" />
              <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-[#c4c7c7] dark:border-[#3a3d45] group-hover:border-[#785919] dark:group-hover:border-[#eac076]" />
              <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-[#c4c7c7] dark:border-[#3a3d45] group-hover:border-[#785919] dark:group-hover:border-[#eac076]" />
              
              <span className="font-display text-3xl sm:text-4xl font-extrabold text-black dark:text-white tracking-tighter mb-2 group-hover:text-[#785919] dark:group-hover:text-[#eac076] transition-colors leading-none">
                {stat.value}
              </span>
              <span className="font-display text-[10px] tracking-widest font-extrabold text-stone-500 dark:text-[#8b8e93] mb-2 block uppercase">
                {stat.label}
              </span>
              <p className="font-sans text-xs text-gray-400 dark:text-[#b0b3b8] mt-1 leading-snug">
                {stat.detail}
              </p>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-24">
          ...
          {/* Left Block photo */}
          <div className="lg:col-span-6 relative h-[400px] sm:h-[480px] rounded-lg overflow-hidden border border-[#e9e8e7] dark:border-[#3a3d45]" id="about-brand-photo">
            <Image
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-black/85 backdrop-blur-sm p-6 rounded-sm border-l-4 border-secondary dark:border-[#eac076] text-white">
          ...
          <div className="lg:col-span-6 flex flex-col space-y-6">
            <div>
              <span className="font-display text-[10px] tracking-[0.25em] font-extrabold text-[#785919] dark:text-[#eac076] uppercase block mb-3">
                FOUNDED IN 1998
              </span>
              <h2 className="font-display font-extrabold text-2xl sm:text-3xl text-black dark:text-white leading-tight uppercase tracking-tight">
                Our Architectural Journey
              </h2>
              <div className="w-12 h-1 bg-[#785919] dark:bg-[#eac076] mt-3 rounded-full" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-stone-200 dark:border-[#3a3d45]">
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-sm bg-[#785919]/5 dark:bg-[#eac076]/10 border border-[#785919]/25 dark:border-[#eac076]/25 flex items-center justify-center text-[#785919] dark:text-[#eac076] shrink-0">
                  <Target className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-display font-bold text-sm text-black dark:text-white uppercase mb-1">Our Objective</h4>
                  <p className="font-sans text-xs text-gray-400 dark:text-[#b0b3b8]">Engineering maximum system longevity and safety coefficients.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-display font-bold text-sm text-black dark:text-white uppercase mb-1">Our Standards</h4>
                  <p className="font-sans text-xs text-gray-400 dark:text-[#b0b3b8]">Exceeding ISO 9001 quality audits with stringent compliance metrics.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-black dark:bg-[#0a0b0e] text-white p-8 sm:p-12 rounded-lg border border-[#785919]/20 dark:border-[#eac076]/20 relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 text-center" id="safety-protocol-timeline">
              {[
                ...
                <div key={i} className="flex flex-col items-center bg-white/5 border border-white/5 p-5 rounded-sm shadow-sm hover:bg-stone-900 dark:hover:bg-[#1a1c22] transition-all">
                  <span className="font-mono text-xs font-bold text-[#eac076] bg-[#785919]/20 dark:bg-[#eac076]/20 px-2 py-1 rounded-sm mb-3">
                    {item.step}
                  </span>
