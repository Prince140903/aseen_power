...
export default function AdminSettingsTab() {
    ...
    try {
      ...
      setSettings({
        site: {
          ...
          tagline: data.settings.site_tagline,
        ...
        security: {
          documentAccessPassword:
            data.settings.security_document_access_password,
        },

        social: {
          linkedin: data.settings.social_linkedin,
          twitter: data.settings.social_twitter,
          facebook: data.settings.social_facebook,
        },

        footer: {
          companyDescription: data.settings.footer_company_description,
          yearFounded: data.settings.footer_year_founded,
          copyrightText: data.settings.footer_copyright_text,
        },
      });
  ...
  const handleSave = async () => {
    if (!settings) return;
    try {
      // Flatten nested settings to match DB column names
      const flatSettings = {
        site_title: settings.site.title,
        site_tagline: settings.site.tagline,
        ...
        footer_company_description: settings.footer.companyDescription,
        footer_year_founded: settings.footer.yearFounded,
        footer_copyright_text: settings.footer.copyrightText,
      };
