...
export function PremiumCursor() {
  ...
  useEffect(() => {
    ...
    const handleInteractiveHover = (e: MouseEvent) => {
      ...
      const isInteractive = target.matches('button, a, [role="button"], input, textarea, select, [data-interactive]');
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed w-10 h-10 border-2 border-[#785919] rounded-full pointer-events-none z-50 opacity-0"
      />
      ...
      <motion.div
        ...
        className="fixed w-3 h-3 bg-[#785919] rounded-full pointer-events-none z-50"
      />
    </>
  );
}
