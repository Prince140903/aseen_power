      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16" id="contact-quickcontacts-grid">
          ...
          <div className="bg-white dark:bg-[#1a1c22] p-6 rounded-lg border border-[#e9e8e7] dark:border-[#3a3d45] text-left block">
            ...
            <h3 className="font-display font-bold text-sm text-stone-900 dark:text-white uppercase mb-1">License Rating</h3>
            <p className="font-sans text-stone-600 dark:text-[#b0b3b8] text-xs">Class-A Super Contractor</p>
            <span className="text-[10px] text-gray-400 dark:text-[#8b8e93] block mt-2 font-mono">Central CEA Certified Rating</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24" id="contact-master-portal">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-[#1a1c22] p-8 sm:p-12 rounded-lg border border-[#e9e8e7] dark:border-[#3a3d45] shadow-sm relative">
            <div>
              <span className="font-display text-[10px] tracking-widest font-extrabold text-[#785919] dark:text-[#eac076] uppercase block mb-2">
                PROJECT METRICS TRANSMISSION
              </span>
              <h2 className="font-display font-extrabold text-2xl text-black dark:text-white uppercase mb-6">
            ...
            {formSubmitted ? (
              ...
              >
                ...
                <h4 className="font-display font-bold text-lg text-black dark:text-white mb-2">
                  Project Docket Successfully Created
                </h4>
                <p className="font-sans text-xs text-gray-500 dark:text-[#8b8e93] max-w-sm mb-4">
                ...
                <div className="font-mono text-[10px] text-[#785919] dark:text-[#eac076] bg-stone-50 dark:bg-[#23252d] border border-stone-200 dark:border-[#3a3d45] p-3 rounded-sm leading-snug w-full max-w-md text-left">
                  <span className="font-bold uppercase block text-stone-500 dark:text-[#8b8e93] mb-1 font-display text-[9px] tracking-wider">PROJECT METRICS INDEX</span>
              ...
              <>
                {formError && (
                  ...
                  >
                    ...
                    <p className="font-sans text-xs text-red-700 dark:text-red-300">{formError}</p>
                  </motion.div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        className="w-full bg-stone-50 dark:bg-[#23252d] border border-[#c4c7c7] dark:border-[#3a3d45] focus:border-[#785919] dark:focus:border-[#eac076] focus:outline-none rounded-sm px-4 py-3 font-sans text-sm text-black dark:text-white placeholder:text-gray-400 dark:placeholder:text-[#8b8e93] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        disabled={formLoading}
                        className="w-full bg-stone-50 dark:bg-[#23252d] border border-[#c4c7c7] dark:border-[#3a3d45] focus:border-[#785919] dark:focus:border-[#eac076] focus:outline-none rounded-sm px-4 py-3 font-sans text-sm text-black dark:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                  ...
                  <div className="flex flex-col">
                    ...
                    <textarea
                      ...
                      disabled={formLoading}
                      rows={4}
                      className="w-full bg-stone-50 dark:bg-[#23252d] border border-[#c4c7c7] dark:border-[#3a3d45] focus:border-[#785919] dark:focus:border-[#eac076] focus:outline-none rounded-sm px-4 py-3 font-sans text-sm text-black dark:text-white placeholder:text-gray-400 dark:placeholder:text-[#8b8e93] resize-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                  </div>
          ...
          <div className="lg:col-span-5 flex flex-col space-y-10 justify-between">
            ...
            <div className="space-y-4">
              <h3 className="font-display text-xs tracking-widest font-extrabold text-stone-500 dark:text-[#8b8e93] uppercase mb-4">
                COMMON CONTRACT FAQ
              </h3>
              ...
              {faqs.map((faq, idx) => (
                ...
                >
                  <button
                    ...
                    className="w-full text-left px-5 py-4 flex items-center justify-between font-display font-semibold text-xs tracking-wide text-black dark:text-white hover:bg-stone-50 dark:hover:bg-[#23252d]"
                  >
                    <span className="uppercase">{faq.q}</span>
                    <ChevronRight size={14} className={`text-stone-400 dark:text-[#8b8e93] transition-transform ${activeFaq === idx ? 'rotate-90 text-[#785919] dark:text-[#eac076]' : ''}`} />
                  </button>

                  {activeFaq === idx && (
                    <div className="px-5 pb-4 font-sans text-xs text-gray-400 dark:text-[#b0b3b8] border-t border-gray-100 dark:border-[#3a3d45] pt-3 leading-relaxed">
                      {faq.a}
                    </div>
                  )}
                </div>
